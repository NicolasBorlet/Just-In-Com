...
export interface ApiContactMessageContactMessage
  ...
  info: {
    ...
    displayName: 'Demande de contact';
  ...
  attributes: {
    ...
    reason: Schema.Attribute.Enumeration<
      ['mariage', 'prive', 'professionnel', 'autre']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'mariage'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logo_extensed: Schema.Attribute.Component<'elements.logo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    menu: Schema.Attribute.Component<'blocks.navigation', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    social_links: Schema.Attribute.Component<'elements.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMariageMariage extends Struct.SingleTypeSchema {
  collectionName: 'mariages';
  info: {
    description: '';
    displayName: 'Mariage';
    pluralName: 'mariages';
    singularName: 'mariage';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::mariage.mariage': ApiMariageMariage;
