            ...
            <div className="py-24 bg-[#772D44] text-white mt-48">
                <div className="flex flex-col gap-12 items-center">
                    <Link href="/" className="flex items-center gap-4">
                        <Image src={`${strapiUrl}${global?.logo_extensed.image.url}`} alt={global?.logo_extensed.image.alternativeText || global?.logo_extensed.logoText || "Logo"} width={450} height={100} />
                    </Link>
